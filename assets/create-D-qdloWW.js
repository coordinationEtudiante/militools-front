import{An as e,B as t,C as n,Cn as r,En as i,G as a,H as o,K as s,Kt as c,Mn as l,Nn as u,Qn as d,Qt as f,Sn as p,Tn as m,Tt as h,Un as g,X as _,Xt as v,Zn as y,Zt as b,_t as x,an as S,bn as C,bt as w,cn as T,en as E,f as D,hn as O,ht as k,in as A,mt as j,n as ee,nn as M,o as N,on as P,q as te,qn as F,r as I,rn as L,sn as R,tn as z,tr as B,u as V,wn as H,wt as U,xt as W}from"./vue-i18n-Dd-f5b4D.js";import{n as ne,r as G}from"./check-014UZMK0.js";import{n as K,r as q,t as re}from"./CreateField-wYDk04X9.js";import{t as J}from"./autocomplete-DqHZgDyN.js";import{t as ie}from"./angle-right-Bsw8p702.js";import{t as ae}from"./message-DVkvcBSz.js";import{t as oe}from"./inputPhone-D9TBjZOD.js";import{t as se}from"./toast-CPnXCwjO.js";import{B as ce,F as le,I as ue,M as de,N as fe,V as pe,a as me,c as Y,d as he,r as ge,w as X}from"./index-Dj5pYV-5.js";import{t as Z}from"./phone.utils-D-e8CMam.js";import{t as _e}from"./MCard-BflvL0tF.js";import{t as ve}from"./contactValidation.utils-Bx28pSIN.js";var ye=D.extend({name:`tieredmenu`,style:`
    .p-tieredmenu {
...
`,classes:{root:function(e){var t=e.instance,n=e.props;return[`p-toggleswitch p-component`,{"p-toggleswitch-checked":t.checked,"p-disabled":n.disabled,"p-invalid":t.$invalid}]},input:`p-toggleswitch-input`,slider:`p-toggleswitch-slider`,handle:`p-toggleswitch-handle`},inlineStyles:{root:{position:`relative`}}}),Q={name:`ToggleSwitch`,extends:{name:`BaseToggleSwitch`,extends:le,props:{trueValue:{type:null,default:!0},falseValue:{type:null,default:!1},readonly:{type:Boolean,default:!1},tabindex:{type:Number,default:null},inputId:{type:String,default:null},inputClass:{type:[String,Object],default:null},inputStyle:{type:Object,default:null},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:Ie,provide:function(){return{$pcToggleSwitch:this,$parentInstance:this}}},inheritAttrs:!1,emits:[`change`,`focus`,`blur`],methods:{getPTOptions:function(e){return(e===`root`?this.ptmi:this.ptm)(e,{context:{checked:this.checked,disabled:this.disabled}})},onChange:function(e){if(!this.disabled&&!this.readonly){var t=this.checked?this.falseValue:this.trueValue;this.writeValue(t,e),this.$emit(`change`,e)}},onFocus:function(e){this.$emit(`focus`,e)},onBlur:function(e){var t,n;this.$emit(`blur`,e),(t=(n=this.formField).onBlur)==null||t.call(n,e)}},computed:{checked:function(){return this.d_value===this.trueValue},dataP:function(){return h({checked:this.checked,disabled:this.disabled,invalid:this.$invalid})}}},Le=[`data-p-checked`,`data-p-disabled`,`data-p`],Re=[`id`,`checked`,`tabindex`,`disabled`,`readonly`,`aria-checked`,`aria-labelledby`,`aria-label`,`aria-invalid`],ze=[`data-p`],Be=[`data-p`];function Ve(e,t,n,i,a,o){return C(),A(`div`,O({class:e.cx(`root`),style:e.sx(`root`)},o.getPTOptions(`root`),{"data-p-checked":o.checked,"data-p-disabled":e.disabled,"data-p":o.dataP}),[z(`input`,O({id:e.inputId,type:`checkbox`,role:`switch`,class:[e.cx(`input`),e.inputClass],style:e.inputStyle,checked:o.checked,tabindex:e.tabindex,disabled:e.disabled,readonly:e.readonly,"aria-checked":o.checked,"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel,"aria-invalid":e.invalid||void 0,onFocus:t[0]||=function(){return o.onFocus&&o.onFocus.apply(o,arguments)},onBlur:t[1]||=function(){return o.onBlur&&o.onBlur.apply(o,arguments)},onChange:t[2]||=function(){return o.onChange&&o.onChange.apply(o,arguments)}},o.getPTOptions(`input`)),null,16,Re),z(`div`,O({class:e.cx(`slider`)},o.getPTOptions(`slider`),{"data-p":o.dataP}),[z(`div`,O({class:e.cx(`handle`)},o.getPTOptions(`handle`),{"data-p":o.dataP}),[r(e.$slots,`handle`,{checked:o.checked})],16,Be)],16,ze)],16,Le)}Q.render=Ve;function He(e,t=!0){return Y(`:area/contact/create`,{body:{data:e},method:`POST`,immediate:t})}function Ue(e,t,n=!0){return Y(`:area/contact/edit`,{body:{contactId:e,data:t},method:`POST`,immediate:n})}function We(e){return Y(`:area/contact/getAutocompleteFields`,{query:e,method:`GET`})}function Ge(e){return Y(`:area/contact/getContactById`,{query:e,method:`GET`})}var Ke={class:`flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3`},qe={class:`flex flex-1 flex-col gap-1`},Je={class:`mb-1 flex items-center gap-2`},Ye={class:`text-sm font-medium text-gray-700`},Xe={key:0,class:`pi pi-id-card text-xs text-gray-400`},Ze={key:1,class:`pi pi-bolt text-xs text-gray-400`},Qe={key:2,class:`pi pi-tag text-xs text-gray-400`},$e=[`aria-checked`,`aria-label`,`onKeydown`],et={class:`flex flex-col gap-1 text-sm`},tt={class:`font-medium`},nt={key:0,class:`text-xs text-gray-500`},rt={key:1,class:`text-xs text-gray-500`},it={key:0,class:`pi pi-question-circle mt-2 cursor-help text-gray-400`},$=T({__name:`ContactCreationInput`,props:{id:{},name:{},type:{},description:{},defaultValue:{},primary:{type:Boolean},indexed:{type:Boolean},significance:{},modelValue:{}},emits:[`update:modelValue`,`error`,`update:providedField`,`autofilledContact`],setup(t,{emit:n}){let r=t,i=n,{t:a}=ee(),o=he(),s=E(()=>o.contactTypeValidator.get(r.type)??/.*/),c=E(()=>r.significance),d=E(()=>{if(r.type==`email`)return{type:`email`,inputmode:`email`};if(r.type==`integer`)return{type:`text`,inputmode:`numeric`};if(r.type==`number`)return{type:`text`,inputmode:`decimal`}}),f=g(r.modelValue??r.defaultValue??``),p=E({get:()=>[`true`,`1`].includes(String(f.value)),set:e=>{f.value=e?`true`:`false`}}),h=E({get:()=>String(f.value??``),set:e=>{f.value=e}});function _(){p.value=!p.value}let x=g([]),S=E(()=>r.type.startsWith(`enum`)),w=E(()=>ve(r.type,s.value)),T=g([]);e(w,e=>{T.value=[...e]},{immediate:!0});function D(e){let t=e.query.trim().toLowerCase();T.value=w.value.filter(e=>e.toLowerCase().includes(t))}function O(e){return e.primaryFields?.find(e=>e.name!==r.name)??null}e(()=>r.modelValue,e=>{e!==void 0&&typeof f.value==`string`&&f.value!==e&&(f.value=e)});let k=!1;e(f,e=>{typeof e==`object`&&e?U(e):typeof e==`string`&&!k&&i(`update:modelValue`,e)});let j=E({get:()=>typeof f.value==`object`?f.value.output:f.value,set:e=>{f.value=e}}),N=E(()=>{if(!j.value)return!1;let e=r.type==`phone`?Z(j.value):j.value;return!s.value.test(e.trim())});e(N,e=>i(`error`,e),{immediate:!0});function te(){if(r.type!==`phone`||typeof f.value!=`string`)return;let e=Z(f.value);e!==f.value&&(f.value=e)}async function F(e){if(e.length<2){x.value=[];return}let t=We({field:String(r.id),partial:e});await t.doFetch(),x.value=t.data.value?.proposals??[]}async function I(e){await F(e.query)}let V=E(()=>{if(r.type===`phone`)return x.value.map(e=>{let t=O(e);return{value:e.output,detail:t?`${t.name}: ${t.value}`:void 0}})});function H(e){let t=x.value.find(t=>t.output===e)??x.value.find(t=>Z(t.output)===Z(e));t&&U(t)}async function U(e){if(k=!0,f.value=e.output,i(`update:modelValue`,e.output),c.value===`other`){k=!1;return}let t=Ge({id:String(e.contactId),fields:`*`});await t.doFetch();let n=t.data.value;if(!n){k=!1;return}i(`update:providedField`,n.fields.map(e=>({field:e.id,value:e.value}))),i(`autofilledContact`,e.contactId),k=!1}return(e,n)=>{let i=m(`tooltip`);return C(),A(`div`,Ke,[z(`div`,qe,[z(`div`,Je,[z(`span`,Ye,B(t.name),1),c.value===`primary`?u((C(),A(`i`,Xe,null,512)),[[i,y(a)(`primary.description`)]]):c.value===`recomended`?u((C(),A(`i`,Ze,null,512)),[[i,y(a)(`recomended.description`)]]):u((C(),A(`i`,Qe,null,512)),[[i,y(a)(`other.description`)]])]),r.type==`boolean`?(C(),A(`div`,{key:0,role:`switch`,"aria-checked":p.value,"aria-label":t.name,tabindex:`0`,class:`flex w-fit cursor-pointer items-center gap-2 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-(--primary-color)`,onKeydown:[v(b(_,[`prevent`]),[`space`]),v(b(_,[`prevent`]),[`enter`])]},[R(y(Q),{modelValue:p.value,"onUpdate:modelValue":n[0]||=e=>p.value=e,variant:`filled`,inputId:String(t.id),tabindex:-1},null,8,[`modelValue`,`inputId`])],40,$e)):S.value?(C(),M(y(J),{key:1,modelValue:j.value,"onUpdate:modelValue":n[1]||=e=>j.value=e,inputId:String(t.id),suggestions:T.value,onComplete:D,dropdown:``,invalid:N.value,fluid:``},null,8,[`modelValue`,`inputId`,`suggestions`,`invalid`])):r.type==`phone`?(C(),M(oe,{key:2,phone:h.value,"onUpdate:phone":n[2]||=e=>h.value=e,disabled:!1,invalid:N.value,suggestions:V.value,onSelect:H,onSearch:F},null,8,[`phone`,`invalid`,`suggestions`])):c.value===`other`?(C(),M(y(fe),{key:3,id:String(t.id),modelValue:j.value,"onUpdate:modelValue":n[3]||=e=>j.value=e,invalid:N.value,"input-props":d.value,fluid:``},null,8,[`id`,`modelValue`,`invalid`,`input-props`])):(C(),M(y(J),{key:4,modelValue:f.value,"onUpdate:modelValue":n[4]||=e=>f.value=e,inputId:String(t.id),suggestions:x.value,optionLabel:`output`,onComplete:I,onBlur:te,invalid:N.value,"input-props":d.value,fluid:``},{option:l(e=>[z(`div`,et,[z(`span`,tt,B(e.option.output),1),c.value!==`primary`&&e.option.primaryFields?.length?(C(),A(`span`,nt,B(e.option.primaryFields.map(e=>`${e.name}: ${e.value}`).join(` · `)),1)):c.value===`primary`&&O(e.option)?(C(),A(`span`,rt,B(`${O(e.option).name}: ${O(e.option).value}`),1)):L(``,!0)])]),_:1},8,[`modelValue`,`inputId`,`suggestions`,`invalid`,`input-props`])),N.value?(C(),M(y(ae),{key:5,severity:`error`,size:`small`,variant:`simple`},{default:l(()=>[P(B(y(a)(`validation.error`)),1)]),_:1})):L(``,!0)]),t.description?u((C(),A(`i`,it,null,512)),[[i,t.description]]):L(``,!0)])}}}),at={class:`text-2xl tracking-tighter text-balance text-gray-950`},ot={class:`flex flex-col gap-4`},st={class:`text-sm text-gray-600`},ct={key:0,class:`py-4`},lt={class:`order-2 flex flex-col flex-wrap gap-4 md:flex-row`},ut={class:`order-4 flex flex-col flex-wrap gap-4 md:flex-row`},dt={class:`order-6 flex flex-col flex-wrap gap-4 md:flex-row`},ft={class:`order-7 flex flex-col items-center gap-4 pt-8`},pt={key:0,class:`flex cursor-pointer items-center gap-2 text-sm text-gray-700`},mt={class:`flex items-center gap-2`},ht={class:`flex items-center gap-2`},gt={class:`flex items-center gap-2`},_t=T({__name:`create`,setup(t){let{t:n}=ee(),r=pe(),i=he(),{getPerms:a}=ge();a([`:area/contact/creates`,`:area/contact/edits`,`:area/contact/getContactFields`,`:area/contact/getDuplicate`]);let o=E(()=>i.fields),s=g({}),c=g({}),u=g(!1),d=g(null),m=g([]),h=g([]),_=g([]),v=g(!1),b=g(`one`),x=g(!1),S=E(()=>Object.values(s.value).every(e=>!e)||Object.values(c.value).some(e=>e));e(()=>i.fields,e=>{let t={...s.value},n={...c.value};e.forEach(e=>{e.id in t||(t[e.id]=e.defaultValue??``),e.id in n||(n[e.id]=!1)}),s.value=t,c.value=n},{immediate:!0});let w=E(()=>[{label:n(`create-contact`),command:()=>{b.value=`one`}},{label:n(`create-contacts`),command:()=>{b.value=`many`}}]);function T(){v.value=!0}async function D(){x.value=!0;let e=new Map(o.value.map(e=>[e.id,e.type])),t=Object.entries(s.value).filter(([,e])=>e!==``).map(([t,n])=>({id:Number(t),value:e.get(Number(t))===`phone`?Z(n):n}));try{let e=u.value&&d.value!==null?Ue(d.value,t,!1):He(t,!1);if(await e.doFetch(),e.errorCode.value&&e.errorCode.value!==200){r.add({severity:`error`,summary:u.value?n(`contact.edit.error`):n(`contact.create.error`),life:3e3});return}r.add({severity:`success`,summary:u.value?n(`contact.edit.success`):n(`contact.create.success`),life:3e3}),b.value===`one`&&await me.push(`/user/contact`)}catch{r.add({severity:`error`,summary:u.value?n(`contact.edit.error`):n(`contact.create.error`),life:3e3})}finally{x.value=!1}}function k(e,t){s.value={...s.value,[e]:t}}function j(e){let t={...s.value};e.forEach(({field:e,value:n})=>{t[e]=n}),s.value=t}function N(e){d.value=e,u.value=!0}return e(()=>i.primaryFields,e=>{m.value=[...e]},{immediate:!0}),e(()=>i.indexedFields,e=>{h.value=[...e]},{immediate:!0}),e(()=>i.otherFields,e=>{_.value=[...e]},{immediate:!0}),(e,t)=>(C(),A(f,null,[R(y(se)),R(_e,{class:`w-full`},{header:l(()=>[z(`h2`,at,B(y(n)(`create-contact.title`)),1)]),default:l(()=>[z(`div`,ot,[z(`p`,st,B(y(n)(`contact.creation.summary`)),1),R(re,{visible:v.value,"onUpdate:visible":t[0]||=e=>v.value=e},null,8,[`visible`]),o.value.length===0?(C(),A(`div`,ct,[R(y(I),{onClick:T},{default:l(()=>[P(B(y(n)(`no-fields-open-modal`)),1)]),_:1})])):L(``,!0),z(`div`,lt,[(C(!0),A(f,null,p(m.value,e=>(C(),M($,O({key:e.id},{ref_for:!0},e,{significance:`primary`,modelValue:s.value[e.id]??``,"onUpdate:modelValue":t=>k(e.id,t),onError:t=>c.value[e.id]=t,"onUpdate:providedField":j,onAutofilledContact:N}),null,16,[`modelValue`,`onUpdate:modelValue`,`onError`]))),128))]),z(`div`,ut,[(C(!0),A(f,null,p(h.value,e=>(C(),M($,O({key:e.id},{ref_for:!0},e,{significance:`recomended`,modelValue:s.value[e.id]??``,"onUpdate:modelValue":t=>k(e.id,t),onError:t=>c.value[e.id]=t,"onUpdate:providedField":j,onAutofilledContact:N}),null,16,[`modelValue`,`onUpdate:modelValue`,`onError`]))),128))]),z(`div`,dt,[(C(!0),A(f,null,p(_.value,e=>(C(),M($,O({significance:`other`,key:e.id},{ref_for:!0},e,{modelValue:s.value[e.id]??``,"onUpdate:modelValue":t=>k(e.id,t),onError:t=>c.value[e.id]=t}),null,16,[`modelValue`,`onUpdate:modelValue`,`onError`]))),128))]),z(`div`,ft,[d.value===null?L(``,!0):(C(),A(`label`,pt,[R(y(Q),{modelValue:u.value,"onUpdate:modelValue":t[1]||=e=>u.value=e,inputId:`edit-existing-contact`},null,8,[`modelValue`]),z(`span`,null,B(y(n)(`create-contact.edit-existing`)),1)])),R(y(Ne),{label:b.value===`one`?y(n)(`create-contact`):y(n)(`create-contacts`),onClick:D,model:w.value,disabled:S.value||x.value},null,8,[`label`,`model`,`disabled`])]),R(y(q),{class:`order-1`,align:`left`,type:`solid`},{default:l(()=>[z(`div`,mt,[z(`span`,null,B(y(n)(`primary.description`)),1),R(y(X),{multiple:``,modelValue:m.value,"onUpdate:modelValue":t[2]||=e=>m.value=e,options:y(i).primaryFields,optionLabel:`name`,filter:``,maxSelectedLabels:3,class:`min-w-48`},null,8,[`modelValue`,`options`]),R(y(I),{severity:`secondary`,text:``,onClick:T},{default:l(()=>[R(y(K))]),_:1})])]),_:1}),R(y(q),{class:`order-3`,align:`left`,type:`solid`},{default:l(()=>[z(`div`,ht,[z(`span`,null,B(y(n)(`recomended.description`)),1),R(y(X),{multiple:``,modelValue:h.value,"onUpdate:modelValue":t[3]||=e=>h.value=e,options:y(i).indexedFields,optionLabel:`name`,filter:``,maxSelectedLabels:3,class:`min-w-48`},null,8,[`modelValue`,`options`]),R(y(I),{severity:`secondary`,text:``,onClick:T},{default:l(()=>[R(y(K))]),_:1})])]),_:1}),R(y(q),{class:`order-5`,align:`left`,type:`solid`},{default:l(()=>[z(`div`,gt,[z(`span`,null,B(y(n)(`other.description`)),1),R(y(X),{multiple:``,modelValue:_.value,"onUpdate:modelValue":t[4]||=e=>_.value=e,options:y(i).otherFields,optionLabel:`name`,filter:``,maxSelectedLabels:3,class:`min-w-48`},null,8,[`modelValue`,`options`]),R(y(I),{severity:`secondary`,text:``,onClick:T},{default:l(()=>[R(y(K))]),_:1})])]),_:1})])]),_:1})],64))}});export{_t as default};